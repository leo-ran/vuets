...
declare type Dropzone = 'copy' | 'move' | 'link';
declare type Dir = 'ltr' | 'rtl' | 'auto';
declare type form_id = string;
declare type form_name = string;
...
interface Div extends BaseElement {
}
declare type Target = '_blank' | '_parent' | '_self' | '_top';
declare type Rel = 'alternate' | 'author' | 'bookmark' | 'external' | 'help' | 'license' | 'next' | 'nofollow' | 'noreferrer' | 'prefetch' | 'prev' | 'search' | 'sidebar' | 'tag';
declare type Shape = 'rect' | 'rectangle' | 'circ' | 'circle' | 'poly' | 'polygon';
...
interface Abbr extends BaseElement {
}
interface Address extends BaseElement {
}
...
interface Article extends BaseElement {
}
interface Aside extends BaseElement {
}
...
interface B extends BaseElement {
}
...
interface Body extends BaseElement {
}
interface Br extends BaseElement {
}
...
interface Caption extends BaseElement {
}
interface Cite extends BaseElement {
}
...
interface Datalist extends BaseElement {
}
interface Dd extends BaseElement {
}
...
interface Dfn extends BaseElement {
}
interface Dl extends BaseElement {
}
interface Dt extends BaseElement {
}
interface Em extends BaseElement {
}
...
interface Figcaption extends BaseElement {
}
interface Figure extends BaseElement {
}
