...
import { PropOptions, WatchOptions } from 'vue/types/options';
/**
 * PropDecorator
 *
 * Example
 ...
 * @license MIT
 */
export declare const Prop: <V extends VueClass>(propType?: PropOptions<any> | (() => any) | (new (...args: any[]) => any) | import("../../node_modules/vue/types/options").Prop<any>[] | undefined) => VueDecorator;
/**
 * ModelDecorator
 *
 * Example
 ...
 * @license MIT
 */
export declare const Model: <V extends VueClass>(event?: string | undefined, propType?: PropOptions<any> | (() => any) | (new (...args: any[]) => any) | import("../../node_modules/vue/types/options").Prop<any>[] | undefined) => VueDecorator;
/**
 * WatchDecorator
 *
 * Example
